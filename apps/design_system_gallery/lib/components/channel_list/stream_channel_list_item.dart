  ...
  return ColoredBox(
    ...
    child: Center(
      child: StreamChannelListItem(
        ...
        title: title,
        titleTrailing: showMuteIcon ? Icon(icons.mute, size: 16, color: colorScheme.textTertiary) : null,
        subtitle: subtitle,
        timestamp: timestamp,
          ...
          child: Column(
            children: [
              StreamChannelListItem(
                ...
                title: 'Jane Doe',
                subtitle: 'Hey! Are you free for a call?',
                timestamp: '9:41',
                unreadCount: 3,
              ),
              StreamChannelListItem(
          ...
          child: Column(
            children: [
              StreamChannelListItem(
                ...
                title: 'Design Team',
                subtitle: 'Alice: New mockups ready for review',
                timestamp: '9:41',
                unreadCount: 5,
              ),
              StreamChannelListItem(
                ...
                title: 'Engineering',
                subtitle: 'Bob: PR merged successfully',
                timestamp: '10:15',
                unreadCount: 12,
              ),
              StreamChannelListItem(
                ...
                subtitle: 'Carol: Meeting notes attached',
                timestamp: 'Yesterday',
              ),
            ],
          ),
          ...
          child: Column(
            children: [
              StreamChannelListItem(
                ...
                title: 'Very Long Channel Name That Should Be Truncated Properly',
                subtitle:
