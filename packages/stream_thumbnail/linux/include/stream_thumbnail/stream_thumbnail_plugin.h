...
typedef struct _StreamThumbnailPlugin StreamThumbnailPlugin;
typedef struct {
  GObjectClass parent_class;
} StreamThumbnailPluginClass;

FLUTTER_PLUGIN_EXPORT GType stream_thumbnail_plugin_get_type();

FLUTTER_PLUGIN_EXPORT void stream_thumbnail_plugin_register_with_registrar(FlPluginRegistrar *registrar);
