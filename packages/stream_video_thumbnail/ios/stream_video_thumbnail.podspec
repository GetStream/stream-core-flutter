...
A Flutter plugin for creating a thumbnail from a local video file or from a video URL.
  ...
  s.source           = { :path => '.' }
  s.source_files = 'stream_video_thumbnail/Sources/stream_video_thumbnail/**/*.{h,m}'
  s.public_header_files = 'stream_video_thumbnail/Sources/stream_video_thumbnail/include/**/*.h'
