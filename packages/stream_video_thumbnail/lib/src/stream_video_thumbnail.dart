...
abstract final class StreamVideoThumbnail {
  ...
  static Future<List<XFile>> thumbnailFiles({
    ...
    return StreamVideoThumbnailPlatform.instance.thumbnailFiles(
      videos: videos,
      headers: headers,
  ...
  static Future<XFile> thumbnailFile({
    ...
    return StreamVideoThumbnailPlatform.instance.thumbnailFile(
      video: video,
      headers: headers,
      thumbnailPath: thumbnailPath,
      imageFormat: imageFormat,
  ...
  static Future<Uint8List> thumbnailData({
    ...
    return StreamVideoThumbnailPlatform.instance.thumbnailData(
      video: video,
      headers: headers,
      imageFormat: imageFormat,
      maxHeight: maxHeight,
