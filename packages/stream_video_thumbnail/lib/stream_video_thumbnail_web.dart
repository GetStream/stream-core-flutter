...
import 'src/stream_video_thumbnail_platform.dart';
...
/// A web implementation of the [StreamVideoThumbnailPlatform].
class StreamVideoThumbnailWeb extends StreamVideoThumbnailPlatform {
  /// Constructs a [StreamVideoThumbnailWeb].
  StreamVideoThumbnailWeb();

  /// Registers this class as the default [StreamVideoThumbnailPlatform] on web.
  static void registerWith(Registrar registrar) {
    StreamVideoThumbnailPlatform.instance = StreamVideoThumbnailWeb();
  }
