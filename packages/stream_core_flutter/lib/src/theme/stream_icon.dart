...
///
/// If you want to supply custom icons you can extend on this class and override the icons you want to use.
/// Supply the custom icon class to the [StreamTheme] constructor.
///
/// Example:
/// ```dart
