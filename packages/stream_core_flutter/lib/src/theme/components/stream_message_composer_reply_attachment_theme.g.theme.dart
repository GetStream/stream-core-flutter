...
part of 'stream_message_composer_reply_attachment_theme.dart';

// **************************************************************************
// ThemeGenGenerator
// **************************************************************************

mixin _$StreamMessageComposerReplyAttachmentThemeData {
  ...
  static StreamMessageComposerReplyAttachmentThemeData? lerp(
    ...
    return StreamMessageComposerReplyAttachmentThemeData(
  ...
  StreamMessageComposerReplyAttachmentThemeData copyWith({
    ...
    final _this = (this as StreamMessageComposerReplyAttachmentThemeData);
  ...
  StreamMessageComposerReplyAttachmentThemeData merge(
    StreamMessageComposerReplyAttachmentThemeData? other,
  ) {
    final _this = (this as StreamMessageComposerReplyAttachmentThemeData);
  ...
  bool operator ==(Object other) {
    ...
    final _this = (this as StreamMessageComposerReplyAttachmentThemeData);
    final _other = (other as StreamMessageComposerReplyAttachmentThemeData);
