...
class StreamTheme extends ThemeExtension<StreamTheme> with _$StreamTheme {
  ...
  factory StreamTheme({
    ...
    errorBadgeTheme ??= const StreamErrorBadgeThemeData();
    ...
    return .raw(
      ...
      errorBadgeTheme: errorBadgeTheme,
  ...
  /// The command chip theme for this theme.
  final StreamCommandChipThemeData commandChipTheme;

  /// The context menu theme for this theme.
  final StreamContextMenuThemeData contextMenuTheme;

  /// The context menu action theme for this theme.
  final StreamContextMenuActionThemeData contextMenuActionTheme;
  ...
  /// The error badge theme for this theme.
  final StreamErrorBadgeThemeData errorBadgeTheme;
