...
class StreamAudioWaveformSlider extends StatefulWidget {
  ...
  ///
  /// When true, the thumb uses [activeThumbColor]. When false, the thumb
  /// uses [idleThumbColor].
  ///
  /// Defaults to false.
  final bool isActive;
...
class StreamAudioWaveform extends StatelessWidget {
  ...
  /// The number of wave bars that will be drawn on the screen. When the length
  /// of [waveform] is bigger than [limit] only the last [limit] bars will be
  /// shown.
  ///
  /// Defaults to 100.
  final int limit;
...
class _WaveformPainter extends CustomPainter {
  ...
  bool shouldRepaint(covariant _WaveformPainter oldDelegate) =>
      !const ListEquality<double>().equals(waveform, oldDelegate.waveform) ||
